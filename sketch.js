...
function draw() {
  ...
  pg.push();
  pg.scale(0.54);
  pg.image(img,0-800,0);
  pg.pop();
  pg.scale(0.32);
  pg.image(img2,0+800,0);
  pg.pop();
...
pop ();
  ...
  text("After applying this process the result produced is a fluid animation that adjusts to the screen size, which can be used in various ways. producing video assets that can be used as backgrounds and patterns to complement the existing asset.",200,6780,700,height);
